...
## 1) Caso
- Sistema: Netflix  
- Contexto: Plataforma de streaming global que utiliza datos masivos para personalizar contenido, mejorar la experiencia del usuario y optimizar decisiones de negocio (producción, recomendaciones, retención).
## 2) Conceptos
- Big Data: Conjunto masivo de datos generados por millones de usuarios (visualizaciones, clics, tiempo de reproducción).  
- Análisis de datos: Procesamiento de esos datos para identificar patrones de consumo.  
- Machine Learning: Algoritmos que aprenden de los hábitos del usuario para recomendar contenido.  
- Deep Learning: Redes neuronales avanzadas que mejoran la precisión de recomendaciones.  
- IA: Sistema global que automatiza decisiones inteligentes basadas en datos.
## 3) Relación
- Big Data → proporciona datos  
- Análisis → los interpreta  
- Machine Learning → aprende patrones  
- Deep Learning → mejora precisión  
- IA → aplica decisiones automatizadas  
## 4) Pipeline
1. Recolección de datos (usuarios ven contenido)  
2. Almacenamiento en sistemas distribuidos  
